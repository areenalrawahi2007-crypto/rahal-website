...
(function () {
  ...
  const T = {
    ...
    'home.browseEquipment': { ar: 'تصفح المعدات', en: 'Browse Equipment' },
    ...
    'home.categoriesEyebrow': { ar: 'اختر وجهتك', en: 'Choose your section' },
    'home.categoriesTitle': { ar: 'كل قسم له صفحته الخاصة', en: 'Every section has its own page' },
    'home.categoriesLead': { ar: 'اضغط على أي بطاقة عشان تنتقل مباشرة لصفحة مستقلة فيها كل التفاصيل والخيارات', en: 'Tap any card to go straight to a dedicated page with all the details and options' },
    'home.featuredEyebrow': { ar: 'الأكثر طلباً', en: 'Most Popular' },
    'home.featuredTitle': { ar: 'منتجات مقترحة لرحلتك', en: 'Suggested for your trip' },
