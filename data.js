...
const PRODUCTS = [
  ...
  { id: 'e33', category: 'equipment', name: 'ولاعة فحم وشواء مخصصة', desc: 'ولاعة طويلة مخصصة لإشعال الفحم بأمان وسهولة، مقاومة للرياح.', price: 3, unit: 'القطعة', emoji: '🔥', tags: ['تخييم'] },
  { id: 'e34', category: 'equipment', name: 'أعواد مشاكيك معدنية (طقم)', desc: 'طقم أعواد شواء معدنية قابلة لإعادة الاستخدام، مقاس طويل يبعدك عن حرارة الفحم.', price: 4, unit: 'القطعة', emoji: '🍢', tags: ['تخييم', 'طبخ'] },
  { id: 'e35', category: 'equipment', name: 'ملقط شواء طويل', desc: 'ملقط ستانلس ستيل طويل لقلب اللحم والخضار بأمان فوق الفحم.', price: 3, unit: 'القطعة', emoji: '🥢', tags: ['تخييم', 'طبخ'] },
  { id: 'e36', category: 'equipment', name: 'شبك شواء متنقل صغير', desc: 'شبكة شواء قابلة للطي والحمل، مناسبة لأي سيحة أو تخييم بسيط.', price: 8, unit: 'القطعة', emoji: '🔥', tags: ['تخييم', 'طبخ'] },
  { id: 'e37', category: 'equipment', name: 'قفازات شواء مقاومة للحرارة', desc: 'زوج قفازات يتحمّل الحرارة العالية، يحميك أثناء التعامل مع الفحم والشواية.', price: 5, unit: 'القطعة', emoji: '🧤', tags: ['تخييم', 'معدات سلامة'] },
];
...
const TRIPS = [
  ...
  },
  {
    ...
    desc: 'معدات غوص وسلامة بحرية لاستكشاف فيوردات مسندم — تأجير القارب يرتّبه العميل بشكل منفصل. #مسندم #بحر #نائية',
    items: [{ id: 'e1', qty: 2 }, { id: 'e25', qty: 2 }, { id: 'e26', qty: 1 }],
  },
  {
    id: 't12', name: 'رحلة تسلق جبال مسندم', days: 2, emoji: '🧗',
    desc: 'تسلق جبال مسندم الوعرة المطلة على المياه مباشرة. #مسندم #جبال #نائية',
    items: [{ id: 'e7', qty: 1 }, { id: 'e8', qty: 2 }, { id: 'e27', qty: 2 }],
  },
  {
  ...
  },
  {
    ...
    desc: 'عدة صيد ومعدات سلامة لرحلة صيد قرب جزيرة مصيرة — القارب يرتّبه العميل بشكل منفصل. #الوسطى #بحر #نائية',
    items: [{ id: 'e9', qty: 2 }, { id: 'e25', qty: 2 }],
  },
  {
    id: 't16', name: 'رحلة صحراء الوسطى', days: 2, emoji: '🏜️',
    desc: 'تخييم صحراوي بمنطقة الوسطى قرب الدقم، بعيداً عن أي إزعاج — وسيلة النقل يوفرها العميل. #الوسطى #صحراء #نائية',
    items: [{ id: 'e4', qty: 1 }, { id: 'e5', qty: 2 }, { id: 'e6', qty: 1 }],
  },
  {
