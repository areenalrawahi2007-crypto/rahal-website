// بيانات الموقع — عدّل أو أضف هنا أي منتج/مورد/قسم جديد
...
const PRODUCTS = [
  ...
  // ---- تموين وطعام (food) ----
  { id: 'f1', category: 'food', name: 'وجبة مخيم عشاء فاخر', desc: 'مشاوي وأطباق عمانية جاهزة للتقديم بالمخيم.', price: 9, unit: 'الشخص', emoji: '🍖', tags: ['مخيم'] },
  { id: 'f2', category: 'food', name: 'صندوق مؤن رحلة 3 أيام', desc: 'وجبات معلبة وجافة مجهزة لرحلات الصحراء والجبال.', price: 25, unit: 'الصندوق', emoji: '📦', tags: ['مؤن'] },
  { id: 'f3', category: 'food', name: 'بوفيه إفطار مخيم', desc: 'إفطار عماني تقليدي كامل يوصّل لموقع المخيم.', price: 7, unit: 'الشخص', emoji: '🥙', tags: ['مخيم', 'إفطار'] },
  { id: 'f4', category: 'food', name: 'صندوق ماء وعصائر', desc: '24 عبوة مياه + عصائر طبيعية للرحلة.', price: 6, unit: 'الصندوق', emoji: '🧃', tags: ['مؤن'] },
  { id: 'f5', category: 'food', name: 'وجبة غوص خفيفة', desc: 'سناكات وطاقة سريعة مناسبة بين جلسات الغوص.', price: 5, unit: 'الشخص', emoji: '🥪', tags: ['غوص', 'مؤن'] },
  { id: 'f6', category: 'food', name: 'شواء بحري طازج', desc: 'أسماك طازجة مشوية على الفحم، تُحضّر عند الطلب.', price: 14, unit: 'الشخص', emoji: '🐟', tags: ['بحر', 'مخيم'] },
];
