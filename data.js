...
const TRIPS = [
  {
    ...
    desc: 'خيمة، مبيت، مركبة دفع رباعي، ومؤن جاهزة لثلاثة أيام في الصحراء. #الشرقية #صحراء',
    items: [{ id: 'e4', qty: 1 }, { id: 'e5', qty: 2 }, { id: 'e6', qty: 1 }, { id: 'e10', qty: 1 }, { id: 'v1', qty: 1 }, { id: 'f2', qty: 1 }, { id: 'f4', qty: 1 }],
  },
  {
    id: 't2', name: 'رحلة غوص ساحل مسقط', days: 1, emoji: '🤿',
    desc: 'معدات غوص كاملة لشخصين مع قارب وسناكات طاقة بين الجلسات. #مسقط #بحر',
    items: [{ id: 'e1', qty: 2 }, { id: 'e2', qty: 2 }, { id: 'e3', qty: 2 }, { id: 'e12', qty: 2 }, { id: 'v3', qty: 1 }, { id: 'f5', qty: 2 }],
  },
  {
  ...
  },
  {
    ...
    desc: 'يوم صيد كامل بقارب مع عدة صيد وشواء بحري طازج على الشاطئ. #الشرقية #بحر',
    items: [{ id: 'e9', qty: 2 }, { id: 'v3', qty: 1 }, { id: 'f6', qty: 2 }],
  },
  {
    id: 't5', name: 'رحلة جبل شمس', days: 2, emoji: '🏔️',
    desc: 'تسلق ومبيت بجبل شمس أعلى قمم عُمان، مع جيب دفع رباعي للوصول للمرتفعات. #الداخلية #جبال',
    items: [{ id: 'e7', qty: 1 }, { id: 'e8', qty: 2 }, { id: 'e27', qty: 2 }, { id: 'v1', qty: 1 }, { id: 'f1', qty: 2 }],
  },
  {
  ...
  },
  {
    ...
    desc: 'تنزه بحري على شواطئ صلالة مع قارب سياحي وشواء بحري طازج. #ظفار #بحر',
    items: [{ id: 'e1', qty: 2 }, { id: 'e2', qty: 2 }, { id: 'v11', qty: 1 }, { id: 'f6', qty: 2 }],
  },
  {
  ...
  },
  {
    ...
    desc: 'رحلة غوص وسنوركل ليوم كامل بجزر الديمانيات المحمية طبيعياً. #الباطنة #بحر',
    items: [{ id: 'e1', qty: 2 }, { id: 'e2', qty: 2 }, { id: 'v12', qty: 1 }, { id: 'f5', qty: 2 }],
  },
  {
    id: 't11', name: 'رحلة مسندم البحرية', days: 1, emoji: '🛳️',
    desc: 'جولة بحرية فاخرة بيخت بين فيوردات مسندم الصخرية. #مسندم #بحر',
    items: [{ id: 'v13', qty: 1 }, { id: 'e1', qty: 2 }, { id: 'e25', qty: 2 }, { id: 'f6', qty: 2 }],
  },
  {
  ...
  },
  {
    ...
    desc: 'مغامرة صحراوية بجيب دفع رباعي في رمال البريمي، مع تجهيزات كاملة. #البريمي #صحراء',
    items: [{ id: 'v1', qty: 1 }, { id: 'e4', qty: 1 }, { id: 'f2', qty: 1 }, { id: 'e30', qty: 1 }],
  },
  {
  ...
  },
  {
    ...
    desc: 'رحلة صيد بحرية ليوم كامل قرب جزيرة مصيرة. #الوسطى #بحر',
    items: [{ id: 'v3', qty: 1 }, { id: 'e9', qty: 2 }, { id: 'f6', qty: 2 }, { id: 'e25', qty: 2 }],
  },
  {
    id: 't16', name: 'رحلة صحراء الوسطى', days: 2, emoji: '🏜️',
    desc: 'تخييم صحراوي بمنطقة الوسطى قرب الدقم، بعيداً عن أي إزعاج. #الوسطى #صحراء',
    items: [{ id: 'v1', qty: 1 }, { id: 'e4', qty: 1 }, { id: 'e6', qty: 1 }, { id: 'f2', qty: 1 }],
  },
  {
    id: 't17', name: 'رحلة الباطنة الجبلية', days: 1, emoji: '🚵',
    desc: 'جولة دراجات هوائية بمرتفعات الرستاق الخضراء بالباطنة. #الباطنة #جبال',
    items: [{ id: 'v6', qty: 2 }, { id: 'e11', qty: 2 }, { id: 'e10', qty: 2 }, { id: 'f3', qty: 2 }],
  },
];
