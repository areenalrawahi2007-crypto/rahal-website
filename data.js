...
// حقائب رحلات جاهزة: كل حقيبة حزمة من نفس منتجات الكتالوج (معدات/مركبات/طعام) لا خدمات جديدة.
...
const TRIPS = [
  {
    ...
    desc: 'خيمة، مبيت، ومؤن جاهزة لثلاثة أيام في الصحراء — وسيلة النقل يوفرها العميل. #الشرقية #صحراء',
    items: [{ id: 'e4', qty: 1 }, { id: 'e5', qty: 2 }, { id: 'e6', qty: 1 }, { id: 'e10', qty: 1 }, { id: 'f2', qty: 1 }, { id: 'f4', qty: 1 }],
  },
  {
    id: 't2', name: 'رحلة غوص ساحل مسقط', days: 1, emoji: '🤿',
    desc: 'معدات غوص كاملة لشخصين مع سناكات طاقة بين الجلسات — القارب أو وسيلة الوصول للبحر يرتّبها العميل. #مسقط #بحر',
    items: [{ id: 'e1', qty: 2 }, { id: 'e2', qty: 2 }, { id: 'e3', qty: 2 }, { id: 'e12', qty: 2 }, { id: 'f5', qty: 2 }],
  },
  {
    id: 't3', name: 'رحلة تسلق جبال الحجر', days: 2, emoji: '🧗',
    desc: 'معدات تسلق آمنة لشخصين مع وجبات عشاء مخيم لليلتين. #الداخلية #جبال',
    items: [{ id: 'e7', qty: 1 }, { id: 'e8', qty: 2 }, { id: 'e11', qty: 2 }, { id: 'e10', qty: 2 }, { id: 'f1', qty: 2 }],
  },
  {
    id: 't4', name: 'رحلة صيد وشواء بحري', days: 1, emoji: '🎣',
    desc: 'يوم صيد من الشاطئ بعدة صيد كاملة ومعدات سلامة، مع شواء بحري طازج. #الشرقية #بحر',
    items: [{ id: 'e9', qty: 2 }, { id: 'e25', qty: 2 }, { id: 'f6', qty: 2 }],
  },
  {
    ...
    items: [{ id: 'e7', qty: 1 }, { id: 'e8', qty: 2 }, { id: 'e27', qty: 2 }, { id: 'f1', qty: 2 }],
  },
  {
    ...
    items: [{ id: 'e25', qty: 2 }, { id: 'e11', qty: 1 }, { id: 'e10', qty: 1 }, { id: 'f4', qty: 1 }],
  },
  {
    id: 't7', name: 'رحلة وادي بني خالد', days: 1, emoji: '💧',
    desc: 'يوم استكشاف وسباحة في برك وادي بني خالد الطبيعية. #الشرقية #وديان',
    items: [{ id: 'e25', qty: 2 }, { id: 'e26', qty: 1 }, { id: 'e11', qty: 1 }, { id: 'f4', qty: 1 }],
  },
  {
    id: 't8', name: 'رحلة صلالة الساحلية', days: 1, emoji: '🌊',
    desc: 'معدات غوص وسنوركل تناسب شواطئ صلالة، مع شواء بحري طازج — النقل يرتّبه العميل. #ظفار #بحر',
    items: [{ id: 'e1', qty: 2 }, { id: 'e2', qty: 2 }, { id: 'e25', qty: 2 }, { id: 'f6', qty: 2 }],
  },
  {
    ...
    items: [{ id: 'e4', qty: 1 }, { id: 'e5', qty: 2 }, { id: 'e27', qty: 2 }, { id: 'f1', qty: 2 }],
  },
  {
    ...
    items: [{ id: 'e1', qty: 2 }, { id: 'e2', qty: 2 }, { id: 'e25', qty: 2 }, { id: 'f5', qty: 2 }],
  },
  {
    ...
    items: [{ id: 'e1', qty: 2 }, { id: 'e25', qty: 2 }, { id: 'e26', qty: 1 }, { id: 'f6', qty: 2 }],
  },
  {
    id: 't12', name: 'رحلة تسلق جبال مسندم', days: 2, emoji: '🧗',
    desc: 'تسلق جبال مسندم الوعرة المطلة على المياه مباشرة. #مسندم #جبال',
    items: [{ id: 'e7', qty: 1 }, { id: 'e8', qty: 2 }, { id: 'e27', qty: 2 }, { id: 'f3', qty: 2 }],
  },
  {
  ...
  },
  {
    ...
    desc: 'جولة مشي بمرتفعات الرستاق الخضراء بالباطنة، مع حقيبة ظهر وإضاءة وإفطار عماني. #الباطنة #جبال',
    items: [{ id: 'e11', qty: 2 }, { id: 'e10', qty: 2 }, { id: 'f3', qty: 2 }],
  },
];
